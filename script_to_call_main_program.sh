...
if [[ ${TYPE_OF_PROGRAM} == 'APPLY_MAT_TRANFORM_BEFORE_DEEPREG_COLIHM62_MOVING_RIS_SNIPR_NWU_COMP' ]]; then
  echo " I AM AT APPLY_MAT_TRANFORM_BEFORE_DEEPREG_COLIHM62_MOVING_RIS_SNIPR_NWU_COMP" >> /software/ERROR.txt
  echo " I AM AT APPLY_MAT_TRANFORM_BEFORE_DEEPREG_COLIHM62_MOVING_RIS_SNIPR_NWU_COMP"
