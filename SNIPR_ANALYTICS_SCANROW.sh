...
scan_analytics=${sessions_list%_sessions.csv}_SCAN_ANALYTICS_${time_now}.csv
scan_analytics_nofilename=${sessions_list%_sessions.csv}_SCAN_ANALYTICS_NOFILENAME${time_now}.csv
