...
column_value_1=$(cat ${dir_to_receive_the_data}/*WashU_EDEMA_BIOMARKERS_COMBINED_20230912002214*_hist.csv | wc -l )
...
column_value=$(( column_value -1 ))
column_value_1=$(cat ${dir_to_receive_the_data}/*COLI_EDEMA_BIOMARKERS_COMBINED_20231003124834*_hist.csv | wc -l )
column_value_1=$(( column_value_1 -1 ))
call_latex_start_arguments=('write_a_col_on_tex' ${latexfilename} ${column_name} ${column_value})
#outputfiles_present=$(python3 utilities_simple_trimmed.py "${call_latex_start_arguments[@]}")
...
column_value=$(( column_value -1 ))
column_value_1=$(cat ${dir_to_receive_the_data}/*ICH2023_06_06_EDEMA_BIOMARKERS_COMBINED_*_hist.csv | wc -l )
column_value_1=$(( column_value_1 -1 ))
call_latex_start_arguments=('write_a_col_on_tex' ${latexfilename} ${column_name} ${column_value})
#outputfiles_present=$(python3 utilities_simple_trimmed.py "${call_latex_start_arguments[@]}")
...
column_value=$(( column_value -1 ))
column_value_1=$(cat ${dir_to_receive_the_data}/*MGBBMC_EDEMA_BIOMARKERS_COMBINED_20231009173614_modified_20231016200619*_hist.csv | wc -l )
column_value_1=$(( column_value_1 -1 ))
call_latex_start_arguments=('write_a_col_on_tex' ${latexfilename} ${column_name} ${column_value})
#outputfiles_present=$(python3 utilities_simple_trimmed.py "${call_latex_start_arguments[@]}")
...
column_value=$(( column_value -1 ))
column_value_1=$(cat ${dir_to_receive_the_data}/*COMBINED_SESSIONS_SAH_METRICS_20231020185756*_hist.csv | wc -l )
column_value_1=$(( column_value_1 -1 ))
call_latex_start_arguments=('write_a_col_on_tex' ${latexfilename} ${column_name} ${column_value})
#outputfiles_present=$(python3 utilities_simple_trimmed.py "${call_latex_start_arguments[@]}")
