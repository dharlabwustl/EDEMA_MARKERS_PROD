...
subject_id_this_session_df=copy_session_df[copy_session_df['ID']==str(session_ID)].reset_index()
subject_id_this_session=subject_id_this_session_df.iloc[0,'subject_id']
for each_unique_subject in unique_subjects:
    subject_df=copy_session_df[copy_session_df['subject_id']==subject_id_this_session]
    print(subject_df)
