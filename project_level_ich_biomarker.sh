...
# if [[ 1 -gt 0 ]] ; then 
    ...
    directory_to_create_destroy
    /software/phe_nwu_ich_calculation.sh $SESSION_ID $XNAT_USER $XNAT_PASS $XNAT_HOST /input1 /output
else
...
#     directory_to_create_destroy
#     /software/phe_nwu_calculation.sh $SESSION_ID $XNAT_USER $XNAT_PASS $XNAT_HOST /input1 /output
