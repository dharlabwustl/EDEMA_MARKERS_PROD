...
if [[ ${TYPE_OF_PROGRAM} == 'APPLY_MAT_TRANFORM_BEFORE_DEEPREG_COLIHM62_MOVING_RIS_DEEPREG_RETURN_TO_SNIPR' ]]; then
  echo " I AM AT APPLY_MAT_TRANFORM_BEFORE_DEEPREG_COLIHM62_MOVING_RIS_DEEPREG_RETURN_TO_SNIPR" >> /software/ERROR.txt
  echo " I AM AT APPLY_MAT_TRANFORM_BEFORE_DEEPREG_COLIHM62_MOVING_RIS_DEEPREG_RETURN_TO_SNIPR"
