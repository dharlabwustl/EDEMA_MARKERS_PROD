...
sshpass -p "$CLUSTER_PASS" \
  ssh \
    ...
    "bash -lc '/rdcw/fs1/dharr/Active/ATUL/PROJECTS/DOCKERIZE/SNIPR_PIPELINE/DISTRIBUTION_OF_LESION/call_COMBINE_EDEMABIOMARKER_N_COMPARTMENTS_1step.sh \"${SESSION_ID}\"'"
