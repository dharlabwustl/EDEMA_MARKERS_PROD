...
scanID=$(python3 -c "from download_with_session_ID import downloadfile_session_withasuffix; downloadfile_session_withasuffix('${sessionID}','${working_dir}',NIFTI_LOCATION,NIFTILOCATION.csv)")
