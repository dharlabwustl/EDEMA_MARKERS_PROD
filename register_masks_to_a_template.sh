...
curl -u $XNAT_USER:$XNAT_PASS -X GET $XNAT_HOST/data/projects/experiments/${sessionID}/scans/${scanID}/resources/${resource_dir}/files?format=zip > ${sessionID}_${scanID}_${resource_dir}.zip
