...
while IFS=',' read -ra array; do
  ...
  while IFS=',' read -ra array1; do
    ...
    split_masks_into_two_halves "_resaved_4DL_normalized_class1.nii.gz"
    #
    ...
    #
    mask_filename5=${working_dir}/${grayscale_filename_basename_noext}_resaved_4DL_normalized_class1_left_half_originalRF.nii.gz
    mask_filename6=${working_dir}/${grayscale_filename_basename_noext}_resaved_4DL_normalized_class1_right_half_originalRF.nii.gz
    #    mask_filename7=${working_dir}/${grayscale_filename_basename_noext}_resaved_levelset_sulci_at_ventricle_v1_left_half_originalRF.nii.gz
    #    mask_filename8=${working_dir}/${grayscale_filename_basename_noext}_resaved_levelset_sulci_at_ventricle_v1_right_half_originalRF.nii.gz
    #    mask_filename9=${working_dir}/${grayscale_filename_basename_noext}_resaved_levelset_sulci_below_ventricle_v1_left_half_originalRF.nii.gz
    #    mask_filename10=${working_dir}/${grayscale_filename_basename_noext}_resaved_levelset_sulci_below_ventricle_v1_right_half_originalRF.nii.gz
    #
    ...
    #    mask_filename24=${working_dir}/${grayscale_filename_basename_noext}_resaved_levelset_ventricle_total_v1.nii.gz
    ...
    #    _resaved_levelset_bet_WITHOUT_ICH_0001_01012017_1028_2_resaved_csf_unet.nii.gz
    mask_filename19_basename=$(basename ${mask_filename19})
    mask_filename19_ext=${mask_filename19_basename##*${grayscale_filename_basename_noext}}
    mask_filename19_ext=${mask_filename19_ext%.nii*}
    mask_filename20_ext=${mask_filename20##*${grayscale_filename_basename_noext}}
    ...
    bet_minus_csf_mask=${bet_mask_WITHOUT_csf} ##${mask_filename19_ext}_WITHOUT_$(basename ${mask_filename20})
    bet_minus_csf_mask_left=${bet_minus_csf_mask%.nii*}_left_half_originalRF.nii.gz
    bet_minus_csf_mask_right=${bet_minus_csf_mask%.nii*}_right_half_originalRF.nii.gz
    ...
    number_of_slices_arguments=('number_of_slices' ${working_dir_1}/${filename_nifti} ${sessionID} ${csvfilename} )

    outputfiles_present=$(python3 dividemasks_into_left_right.py "${number_of_slices_arguments[@]}")
    ###### BET RELATED PARAMETERS ################################

    call_bet_related_parameters_arguments=('call_bet_related_parameters' ${bet_minus_csf_mask_left} ${bet_minus_csf_mask_right} ${bet_minus_csf_mask} ${working_dir_1}/${filename_nifti} ${sessionID} ${csvfilename})
    ...
    call_masks_on_grayscale_colored_arguments=('call_masks_on_grayscale_colored' ${levelset_gray_file} ${contrast_limits} ${outputfile_dir} ${outputfile_suffix} ${color_list} ${output_directory} ${mask_filename3} ${mask_filename4})
    outputfiles_present=$(python3 dividemasks_into_left_right.py "${call_masks_on_grayscale_colored_arguments[@]}")
    ###################################PHE and its REFLECTION
    outputfile_suffix="PHE_AND_PHEMIRROR"
    contrast_limits='20_60'
    ...
    #      remove_space_in_col_name_arguments=('remove_fewchars_in_col_name' ${csvfilename} ${csvfilename} "_V1_" "_")
