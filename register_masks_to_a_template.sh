...
curl -u $XNAT_USER:$XNAT_PASS -X GET $XNAT_HOST/data/projects/experiments/${sessionID}/scans/${scanID}/resources/${resource_dir}/files?format=zip > ${working_dir}/${sessionID}_${scanID}_${resource_dir}.zip
echo "curl -u $XNAT_USER:$XNAT_PASS -X GET $XNAT_HOST/data/projects/experiments/${sessionID}/scans/${scanID}/resources/${resource_dir}/files?format=zip > ${sessionID}_${scanID}_${resource_dir}.zip"
