...
cp ${working_dir}/*_mov_fixed_scct_strippedResampled1_normalized_fix_lin1.* ${output_directory}/
#####
...
/software/bet_withlevelset.sh ${registration_nii_file} ${mask_binary_output_dir}/${bet_binary_output_filename}
