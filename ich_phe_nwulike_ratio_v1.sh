...
run_divide_mask_into_left_right() {
  ...
  local working_dir=${4}
  call_divide_a_mask_into_left_right_submasks_arguments=('call_divide_a_mask_into_left_right_submasks_v1' ${grayimage} ${csf_mask_filename} ${output_directory} ${working_dir})
