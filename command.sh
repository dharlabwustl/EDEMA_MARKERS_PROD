...
container_name=${2}
python3 /software/bulk_start.py  --project COLI --session_id_file ${session_id_filename}  --container ${container_name}  --delay 2 --user ${XNAT_USER} --password ${XNAT_PASS} --host ${XNAT_HOST}
