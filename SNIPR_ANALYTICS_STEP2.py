...
get_latest_filepath_from_metadata_arguments.stuff=[URI,resource_dir,".csv", "sessions_"+project_ID+"_ANALYTICS_STEP1_", file_path_csv]
get_latest_filepath_from_metadata_for_analytics('get_latest_filepath_from_metadata_for_analytics',URI,resource_dir,".csv" "sessions_${project_ID}_ANALYTICS_STEP1_" ,file_path_csv)
