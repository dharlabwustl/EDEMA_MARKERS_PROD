...
#mv  ${output_directory}/ ${output_directory}/${scan_file_basename_no_ext}_left_half_brain_nib_img.nii.gz
half_brain_mask=${output_directory}/'with_copied_params_'left_half_brain_nib_img.nii.gz
