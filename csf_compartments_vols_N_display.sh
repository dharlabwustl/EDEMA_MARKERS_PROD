...
call_masks_on_grayscale_colored_arguments=('call_masks_on_grayscale_colored' ${grayscale_filename_1} ${contrast_limits} ${outputfile_dir} ${outputfile_suffix} ${color_list} ${mask_filename1} ${mask_filename2} ${mask_filename3} ${mask_filename4})
...
#
#  ###############################
#  for x in ${outputfile_dir}/SAH_1_01052014_2003_2_GRAY*.jpg; do
...
#    i=$(($i + 1))
#    images[$i]=${working_dir_1}/SAH_1_01052014_2003_2_resaved_levelsetIML_REGIS_${suffix}_V2.jpg
#    i=$(($i + 1))
