...
/usr/lib/fsl/5.0/flirt -in ${template_image%.nii*}_onlyventricle.nii.gz -ref ${img} -out "${output_filename}${template_image%.nii*}_onlyventricle_lin1_1" -init ${output_filename}_${exten}lin1_1.mat  -applyxfm
