...
then
      ...
      PROJECT_ID_4=SAH
#      PROJECT_ID_4=COLI
    /software/ALL_PROJECTS_COMBINED_ANALYTICS.sh    $XNAT_USER $XNAT_PASS $XNAT_HOST ${PROJECT_ID_1}_${PROJECT_ID_2}_${PROJECT_ID_3}_${PROJECT_ID_4}
fi
if [[ ${TYPE_OF_PROGRAM} == 27 ]] ;
then
      PROJECT_ID=${1}
