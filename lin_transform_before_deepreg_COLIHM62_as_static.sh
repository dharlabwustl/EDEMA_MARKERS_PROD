...
echo scanId::${scanID}
snipr_output_foldername="PREPROCESS_SEGM_4"
...
resource_dirname='PREPROCESS_SEGM_4'
copy_masks_data ${sessionID} ${scanID} ${resource_dirname} ${output_dirname}
...
fixed_image_filename=/software/COLIHM620406202215542.nii.gz ###COLIHM620406202215542.nii.gz ##'  ####${template_prefix}.nii.gz ##${session_ct_bet_gray}
...
cp ${registration_nii_file} /outputinsidedocker/
cp ${infarct_mask_binary_output_filename} /outputinsidedocker/
cp ${mask_binary_output_dir}/${mask_binary_output_filename} /outputinsidedocker/
